...
<html>
    <head>
        <style>
            body {
                background-image: url(image/ucen.jpg);
    ...
    <body>
       <h1>UNIVERSITY COLLEGE OF ENGINEERING NAGERCOIL</h1>
        <h1>STUDENT STATIONERY SHOP</h1>
        <div class="container">
            <div class="content">
       <img   src="image/login-images-png-transparent-3.png" alt="login " width="300px" height="auto">
             <span ><h2>Students Login</h2></span>
            <a href="student/login.php"> <button></button></a>  
            <span> <h2 id="h2">Admin Login</h2></span>
            <a href="Admin/login.php"><button></button></a>
